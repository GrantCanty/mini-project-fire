...
state.robots_pos = {'robot1': 'exit'}

state.robot_has_person = {'robot1': False}
...
state.rooms = {
    ...
    'office-b': {'smokey': False, 'number_of_people': 0}, 
    ...
    'room-2': {'smokey': False, 'number_of_people': 0}, 
    ...
    'stairs-right': {'smokey': True, 'number_of_people': 0},
}
...
for i, person in enumerate(state.persons):
    ...
    task_list.append(('evacuate_person_with_robot', 'robot1', person))
