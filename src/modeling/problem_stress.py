...
state.persons = {
    ...
    # adding new people
    'p11': {'position': 'office-e', 'carried': False},
    'p12': {'position': 'office-e', 'carried': False},
    'p13': {'position': 'room-4', 'carried': False},
    'p14': {'position': 'corridor-3', 'carried': False},
}
...
state.rooms = {
    ...
    # adding new rooms
    'room-4': {'smokey': False, 'number_of_people': 0},
    'corridor-3': {'smokey': False, 'number_of_people': 0},
    'office-d': {'smokey': False, 'number_of_people': 0},
    'office-e': {'smokey': False, 'number_of_people': 0},
}
...
state.connections = {
    ...
    'exit': ['reception'],
    'stairs-left': ['hall', 'room-1', 'office-a', 'office-e'],
    'stairs-right': ['reception', 'corridor-1', 'corridor-2', 'corridor-3'],

    # adding new connections for new rooms
    'room-4': ['corridor-3'],
    'office-d': ['stairs-left', 'office-e'],
    'office-e': ['office-d', 'corridor-3'],
    'corridor-3': ['office-e', 'room-4', 'stairs-right']
}
