(define (problem emergency-evacuation)
  ...
  (:objects
    ...
    ;; people
    p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 - person

    ;; rooms
    office-d office-e corridor-3 room-4
  ...
  (:init
    ...
    ;; 2 people in Office-e
    (person-in p11 office-e)
    (person-in p12 office-e)

    ;; 1 person in room-4
    (person-in p13 room-4)

    ;; 1 person in corridor-3
    (person-in p14 corridor-3)
    ...
    ;; Floor 3
    ;; ----
    (connected office-d office-e)
    (connected office-e office-d)

    (connected office-d stairs-left)
    (connected stairs-left office-d)

    (connected office-e corridor-3)
    (connected corridor-3 office-e)
    
    (connected corridor-3 stairs-right)
    (connected stairs-right corridor-3)

    (connected corridor-3 room-4)
    (connected room-4 corridor-3)
