(define (problem emergency-evacuation)
  ...
  (:init
    ...
    ;; 2 people in Corridor 1
    (person-in p11 corridor-1)
    (person-in p12 corridor-1)

    ;; 2 people in Corridor 2
    (person-in p13 corridor-2)
    (person-in p14 corridor-2)

    ;; 1 person in Reception
    (person-in p15 reception)
