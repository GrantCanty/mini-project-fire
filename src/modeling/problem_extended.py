...
state.robots_pos = {'robot1': 'exit', 'robot2': 'exit', 'robot3': 'exit'}

state.robot_has_person = {'robot1': False, 'robot2': False, 'robot3': False}
...
state.persons = {
    ...
    'p11': {'position': 'corridor-1', 'carried': False},
    'p12': {'position': 'corridor-1', 'carried': False},
    'p13': {'position': 'corridor-2', 'carried': False},
    'p14': {'position': 'corridor-2', 'carried': False},
    'p15': {'position': 'reception', 'carried': False},
}
